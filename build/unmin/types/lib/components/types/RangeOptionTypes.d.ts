...
declare type RandomNumberRangeOptionsT = Interfaces.IRandomNumberRangeOptions;
declare type RandomCharRangeOptionsT = Interfaces.IRandomCharRangeOptions;
declare type RandomStringRangeOptionsT = Interfaces.IRandomStringRangeOptions;
declare type RandomDateRangeOptionsT = Interfaces.IRandomDateRangeOptions;
declare type RandomColorRangeOptionsT = Interfaces.IRandomColorRangeOptions;
declare type ShuffleRangeOptionsT = Interfaces.IShuffleRangeOptions;
...
export { AnyRangeOptionsT, OptionsType, OptionsItemType, OptionsEdgeType, OptionsDateType, CharRangeOptionsT, ColorRangeOptionsT, DateRangeOptionsT, NumberRangeOptionsT, RangeOptionsT, StringRangeOptionsT, MergeRangeOptionsT, ZipRangeOptionsT, RandomRangeOptionsT, RandomNumberRangeOptionsT, RandomCharRangeOptionsT, RandomStringRangeOptionsT, RandomDateRangeOptionsT, RandomColorRangeOptionsT, ShuffleRangeOptionsT, };
